...
echo "src-git fancontrol https://github.com/JiaY-shi/fancontrol.git" >> feeds.conf.default
echo "src-git fantastic_packages https://github.com/fantastic-packages/packages/tree/master/feeds/packages" >> feeds.conf.default
echo "src-git fantastic_luci https://github.com/fantastic-packages/packages/tree/master/feeds/luci" >> feeds.conf.default
